...
# Usando um dicionário para categorizar as afiliações
afiliacoes = {}
...
# Usando NumPy para analisar os interesses dos participantes
...
# Esse código usa:
# Conjuntos (ou sets) para identificar as diferentes regiões dos participantes
# Dicionários para categorizar as afiliações dos participantes
# NumPy para analisar e identificar as áreas de interesse